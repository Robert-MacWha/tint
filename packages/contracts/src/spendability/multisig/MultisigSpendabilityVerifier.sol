...
contract Verifier {
    ...
    uint256 constant ALPHA_X = 21312530258483397217283887441652714489791814762853637281989108360189359369712;
    uint256 constant ALPHA_Y = 2565854265889999339742798658631286213596876842823482117131360456814784876689;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 = 17360482226057167998720917050066766349135238110346549337035384152491300734961;
    uint256 constant BETA_NEG_X_1 = 4483633376180680443246873669274126638970945687020868832364688228834314818482;
    uint256 constant BETA_NEG_Y_0 = 6842396295117425774396419410308632653302343697278972039137603373190848213558;
    uint256 constant BETA_NEG_Y_1 = 16287118392798210409906707974633948752504040528231076281576757434644477223262;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 = 17059675788471360132151342775015519828473644816303542634233173860511284261250;
    uint256 constant GAMMA_NEG_X_1 = 10230666571444688664795364432743589011110334365029283256391403037296142638073;
    uint256 constant GAMMA_NEG_Y_0 = 15145014129400368719404549333961566491288660667558816301371545944043157785564;
    uint256 constant GAMMA_NEG_Y_1 = 15783402372806506470558795507868898650290310994162839412023333110094380195748;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 = 14066612429586454602622778906605245143455131468562491725443463906110614239295;
    uint256 constant DELTA_NEG_X_1 = 8256431279904965519239932579409302507090452986108488103264837480055369555505;
    uint256 constant DELTA_NEG_Y_0 = 18638633068634897664862607838160851880348619179859480013154160222441002063747;
    uint256 constant DELTA_NEG_Y_1 = 10595009544077661884246088376811255188057045986933353126201934171461569148681;
    // Pedersen G point in G2 in powers of i
    uint256 constant PEDERSEN_G_X_0 = 18652105671661366311926962979311770984542623045491603228129087596712831755671;
    uint256 constant PEDERSEN_G_X_1 = 5660330852877158490382121698318529828095545147132291444421614957425166921529;
    uint256 constant PEDERSEN_G_Y_0 = 7884121643996916879416214931836996993543512538044155898577511127431119521962;
    uint256 constant PEDERSEN_G_Y_1 = 6928320795405174441889794780486699663413348821697816733160726991159926251443;

    // Pedersen GSigmaNeg point in G2 in powers of i
    uint256 constant PEDERSEN_GSIGMANEG_X_0 =
        7378894453678177692404422963368777583403415529970298869804723231704204655123;
    uint256 constant PEDERSEN_GSIGMANEG_X_1 =
        13226172530703515919639102420913268590068779989939471130235169742773039047796;
    uint256 constant PEDERSEN_GSIGMANEG_Y_0 =
        12135047062419216239451367665396179998451639751229455882020321443519662139976;
    uint256 constant PEDERSEN_GSIGMANEG_Y_1 =
        3171491647818258215784579364157457370199057350242331821355404757920180611736;

    // Constant and public input points
    uint256 constant CONSTANT_X = 15363889680639235602559603512746833109429322460425633397408578128567878261898;
    uint256 constant CONSTANT_Y = 19237482902607190628935179380814822108509246895939735050214685359846353397480;
    uint256 constant PUB_0_X = 2782417358462348114082183504253414761294017707698977667680888398192121041694;
    uint256 constant PUB_0_Y = 12672545082254502283403998566192035396544978333714077225359759716795114023586;
    uint256 constant PUB_1_X = 14511498908294194353534786767498032207825642542959317319258500844976525114427;
    uint256 constant PUB_1_Y = 3546738151978003947883064471066583400789408941438216180757972328421090855200;
    uint256 constant PUB_2_X = 6353077633589055216082194550354355305823469968765001847771257536710346169282;
    uint256 constant PUB_2_Y = 2175843564141112434140544648424971255563272371098670536665139036836896976806;
