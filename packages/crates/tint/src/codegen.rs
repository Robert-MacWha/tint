...
{ic_constants}
    ...
    function verifyProof(uint256[2] calldata _pA, uint256[2][2] calldata _pB, uint256[2] calldata _pC, uint256[{n_public}] calldata _pubSignals) public view returns (bool) {{
        assembly {{
